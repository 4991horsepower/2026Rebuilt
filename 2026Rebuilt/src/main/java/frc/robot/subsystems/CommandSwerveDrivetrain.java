...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private final SlewRateLimiter xLimiter = new SlewRateLimiter(8.0, -100.0, 0.0);
    private final SlewRateLimiter yLimiter = new SlewRateLimiter(8.0, -100.0, 0.0);
    private final SlewRateLimiter rotLimiter = new SlewRateLimiter(18.0, -200.0, 0.0);
